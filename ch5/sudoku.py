...
# create a standard python dict for map subsquares to the list (row, col) entries
...
# create tje sudoku model for a 10x10 board, where the input
# data board is a list of fixed number specified in
# (row, col, val) tuples
def create_sudoku_model(board):
    ...
    # create sets of for rows columns and squares
    ...
    # fix variables base on the current board
    for (r,c,v) in board:
        model.y[r, c, v].fix(1)
...
# use this function to add new integer cut to the model
