...
# Solve an instance of the warehouse location problems
...
model.y.pprint() # Print the optimal warehouse localtions
# model.pprint() # Print the optimal warehouse localtions
