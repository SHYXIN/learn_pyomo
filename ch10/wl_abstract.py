# wl_abstract.py: AbstractModel version of warehouse localtion determination problem
...
model.one_per_cust_rule = pyo.Constraint(model.M, rule=one_per_cust_rule)
